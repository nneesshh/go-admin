...
import (
	...
	errs "github.com/nneesshh/go-admin/modules/errors"
	...
	form2 "github.com/nneesshh/go-admin/plugins/admin/modules/form"
	"github.com/nneesshh/go-admin/plugins/admin/modules/parameter"
	"github.com/nneesshh/go-admin/plugins/admin/modules/tools"
...
func (s *SystemTable) GetGenerateForm(ctx *context.Context) (generateTool Table) {
	...
	formList.AddField(lgWithScore("extra import package", "tool"), "extra_import_package", db.Varchar, form.Select).
		FieldOptions(types.FieldOptions{
			...
			{Text: "log", Value: "log"},
			{Text: "fmt", Value: "fmt"},
			{Text: "github.com/nneesshh/go-admin/modules/db/dialect", Value: "github.com/nneesshh/go-admin/modules/db/dialect"},
			{Text: "github.com/nneesshh/go-admin/modules/db", Value: "github.com/nneesshh/go-admin/modules/db"},
			{Text: "github.com/nneesshh/go-admin/modules/language", Value: "github.com/nneesshh/go-admin/modules/language"},
			{Text: "github.com/nneesshh/go-admin/modules/logger", Value: "github.com/nneesshh/go-admin/modules/logger"},
		}).
		FieldDefault("").
