...
import (
	...
	errors2 "github.com/nneesshh/go-admin/modules/errors"
	...
	"github.com/nneesshh/go-admin/template/login"
...
type Component interface {
	...
	//
	// See:
	// https://github.com/nneesshh/go-admin/blob/master/template/login/theme1.tmpl#L32
	// https://github.com/nneesshh/go-admin/blob/master/template/login/list.go
	GetAssetList() []string
