...
func buildProject(cfgFile string) {
	...
	if defaultLang == "cn" || p.Language == language.CN || p.Language == "cn" {
		...
		fmt.Println("- sqlite: " + ansi.Color("https://github.com/nneesshh/go-admin/raw/master/data/admin.db", "blue"))
		fmt.Println("- mssql: " + ansi.Color("https://raw.githubusercontent.com/nneesshh/go-admin/master/data/admin.mssql", "blue"))
		fmt.Println("- postgresql: " + ansi.Color("https://raw.githubusercontent.com/nneesshh/go-admin/master/data/admin.pgsql", "blue"))
		fmt.Println("- mysql: " + ansi.Color("https://raw.githubusercontent.com/nneesshh/go-admin/master/data/admin.sql", "blue"))
	}
	fmt.Println()
...
import "github.com/nneesshh/go-admin/plugins/admin/modules/table"
